...
\begin{definition}\label{def:refinement_algo}
  ...
  \rodolphe{Faire ici une explication plus détaillée sur les différentes parties, surtout les parties avec les fragments}
...
\rodolphe{Ici très straightforward mais juste dire que concrètement on va juste prendre la cellule de v et la diviser en 2 cellules, une avec v et une avec les autres éléments de la cellule. (avec la nouvelle cellule avant)}

...
\begin{definition}
    ...
    \end{enumerate}
    The same exponent notation is used to denote the induced action on complex structures derived from $X$. As additional notation, for $W \subseteq X$, we write $W^g = \{w^g : w \in W\}$.

    \rodolphe{Bizarre le complex structures, à voir avec papier et comment combiner avec symmetric group de colouring}

...
\begin{frame}{Isomorphe sans automorphe}
        \centering
        \begin{tabular}{ccc}
          \pawgraph{p3} & \raisebox{0.6cm}{$\cong$} & \pawgraph{p1} \\[0.15cm]
          $G_1$ & & $G_2$
        \end{tabular}
\end{frame}
...
\begin{itemize}
    ...
    used in the operations $\mathcal{P}_C$ that were performed, and let $A = \{g \mathrel{\in}\mathrm(G,\pi_0)$: $\sigma_0^g$ is a remaining leaf\}. Then $\mathrm{Aut}(G,\pi_0)$ is generated by $\{g_1, \ldots, g_k\} \,\cup\, A$.

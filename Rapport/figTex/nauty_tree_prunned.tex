...
% ---------- Step markers ----------
\node[stepmark] (step1) at ($(init.north west)+(-0.3,0.3)$) {1};
\node[stepmark] (step2) at ($(L1.north west)+(-0.3,0.3)$) {2};
\node[stepmark] (step3) at ($(L2.north east)+(-0.3,0.3)$) {3};
\node[stepmark] (step4) at ($(B.north east)+(-0.3,0.3)$) {4};
\node[stepmark] (step5) at ($(L3.north west)+(0.3,0.3)$) {5};
\node[stepmark] (step6) at ($(L4.north east)+(-1,0.4)$) {6};
\node[stepmark] (step7) at ($(C.north east)+(-1,0.4)$) {7};
